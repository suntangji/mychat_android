...
public class SingleChatActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                ...
                break;
            case R.id.quit:
                Toast.makeText(SingleChatActivity.this,"quit",Toast.LENGTH_SHORT ).show();
                Destory();
                break;
        }
        return true;
    ...
    private void initClient() {
        ...
        recvThread = new Thread() {
            ...
            public void run() {
                ...
                while (!isInterrupted()) {
                    ...
                    if (json.getContent().equals("{{CONNECTION DENIED}}")) {
        ...
        sendThread = new Thread() {
            ...
            public void run() {
                ...
                default_json.setTo(userName);
                default_json.setContent("你好，我是" + Global.username);
    ...
    private void showRefuseMessage(){
        Toast.makeText(SingleChatActivity.this, "对方拒绝和你私聊", Toast.LENGTH_SHORT).show();
        finish();
    }
